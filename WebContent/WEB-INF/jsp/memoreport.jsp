...
<select class="field select medium" name="department" id="department" onchange="genericAjaxFunction('displaydepartmentwiseemployeelist.htm?departmentId='+this.value,'POST','employeeListDiv')">
		...
		<c:forEach items="${departmentsList}" var="departmentList" varStatus="status">
...
<li class="buttons ">
<div>
<!-- <input class="btTxt submit" type="button" value="Generate" onclick="return generateReport('generatememoreport.htm?departmentId='+document.getElementById('department').value+'&');"/>
 --><img  src="images/pdf.png" height="35" width="35" onclick="return generateReport('generatememoreport.htm?departmentId='+document.getElementById('department').value+'&');">
<img  src="images/logo-excel.png" height="35" width="35" onclick="return generateReport('generatememoreportInXSL.htm?departmentId='+document.getElementById('department').value+'&');">
<img  src="images/word.jpg" height="35" width="35" onclick="return generateReport('generatememoreportInDocx.htm?departmentId='+document.getElementById('department').value+'&');">
</div>
</li>
</ul>
