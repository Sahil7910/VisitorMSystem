...
<li class="buttons ">
<div>
<!-- <input class="btTxt submit" type="button" value="Generate To Pdf" onclick="return generateReport('generateEmployeeWiseaAllPunchesReport.htm?');"/>
<input class="btTxt submit" type="button" value="Generate To Excel" onclick="return generateReport('generateEmployeeWiseaAllPunchesReportInXSL.htm?');"/>
<input class="btTxt submit" type="button" value="Generate To Word" onclick="return generateReport('generateEmployeeWiseaAllPunchesReportInDocx.htm?');"/>
 --> 
 <img  src="images/pdf.png" height="35" width="35" onclick="return generateReport('generateEmployeeWiseaAllPunchesReport.htm?');">
<img  src="images/logo-excel.png" height="35" width="35" onclick="return generateReport('generateEmployeeWiseaAllPunchesReportInXSL.htm?');">
<img  src="images/word.jpg" height="35" width="35" onclick="return generateReport('generateEmployeeWiseaAllPunchesReportInDocx.htm?');">
</div>
</li>
</ul>
