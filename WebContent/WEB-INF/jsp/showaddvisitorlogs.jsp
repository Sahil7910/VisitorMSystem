...
<form:form encType="multipart/form-data" class="wufoo leftLabel page" action="addvisitorlogs.htm" method="GET" commandName="visitorLogs">
<ul>
...
<div>
<form:select path="visitorId" id="visitorId" class="field select medium">
<form:option value="0">Select</form:option>
...
<%-- <c:forEach items="${visitorStatusList}" varStatus=""></c:forEach> --%>
...
<div>
	...
	&nbsp;&nbsp;No. of People<form:input path="noOfPeople" name="personCount" readonly="true" id="personCount" type="text" value="1"/>
</div>
</li>
