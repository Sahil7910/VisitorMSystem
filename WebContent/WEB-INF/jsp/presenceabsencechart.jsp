...
<title>Presence Absence Chart</title>
</head>
<%
...
<form:form name="EmployeeWiseReport" class="wufoo leftLabel page" id="EmployeeWiseReport" method="POST">
...
<li class="buttons ">
<div>
<input class="btTxt submit" type="button" value="Generate" onclick="presentAbscentAjax();"/>
</div>
</li>
