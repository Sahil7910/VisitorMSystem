...
<form:form name="EmployeeWiseReport" class="wufoo leftLabel page" id="EmployeeWiseReport" method="POST" action="generateShiftWiseBasicWorkDurReport.htm" target="_blank">
...
<li class="buttons ">
<div>
<input class="btTxt submit" type="submit" value="Generate To Pdf" onclick="if(document.getElementById('shiftName').value==0){alert('Shift Not Selected');return false;}"/>
</div>
</li>
