...
<form:form encType="multipart/form-data" class="wufoo leftLabel page" action="generatevehiclefrequencyreport.htm" method="POST" commandName="vehicleLogs" target="_blank">
<ul>
