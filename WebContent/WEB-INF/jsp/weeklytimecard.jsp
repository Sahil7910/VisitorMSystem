...
<form:form name="dailyattendance" class="wufoo leftLabel page" method="POST" action="weeklytimecard.htm">
...
<div>	
	<select class="field select medium" name="dailyattendance" id="dailyattendance">
...
<li class="buttons ">
<div>
<input class="btTxt submit" type="button" value="Generate" onclick="weeklyTimecardAjax()"/>
</div>
</li>
...
<tr><td align="left"><input type="button" value="Generate" onclick="weeklyTimecardAjax()"/></td></tr>
</table> --%>
