...
<form:form class="wufoo leftLabel page" action="saveOrUpdateCompanyPolicies.htm" method="POST" commandName="companyPolicies" enctype="multipart/form-data">
<form:hidden path="policyId" id="cmpPolicyId" name="cmpPolicyId"/>
