...
<title>Total Working Hours Report</title>
</head>
<%
...
<input type="text" id="workingHoursType" value="daily"/>
...
<div>
<span>
<input type="radio" name="workingHoursRadio" checked="checked" id="dailyCheckBox" class="radio" value="daily" onchange="workingHoursfunction();"/>
<label class="choice" for="Field346_0" >
Daily</label>
</span>
<span>
<input class="radio" type="radio" name="workingHoursRadio" id="weaklyCheckBox" value="weakly" onchange="workingHoursfunction();"/>
<label class="choice" for="Field346_1" >
Weakly</label>
</span>
<span>
<input class="radio" type="radio" name="workingHoursRadio" id="monthlyCheckBox" value="monthly" onchange="workingHoursfunction();"/>
...
<li class="buttons ">
<div>
<input class="btTxt submit" type="button" value="Generate" onclick="return generateReport('generateTotalWorkingHoursReport.htm?departmentId='+document.getElementById('department').value+'&workingHoursType='+document.getElementById('workingHoursType').value+'&');"/>
</div>
</li>
</ul>
