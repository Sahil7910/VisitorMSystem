...
<form:form encType="multipart/form-data" class="wufoo leftLabel page" action="updatevisitors.htm" method="POST" commandName="visitors">

<form:hidden path="visitorId" id="visitorId" name="visitorId"/>
<ul>
<%-- <li id="foli110" class="notranslate"><label class="desc" id="title110" for="Field110"></label>
<div>
	<font class="error">${visitorErrorMessage}</font> 
</div>
</li> --%>
...
<li id="foli110" class="notranslate      "><label class="desc" id="title110" for="Field110">Visitor Type</label>
<div id="visitorTypeDiv">
	<form:select path="visitorType" id="visitorType" class="field select medium">
		<form:option value="0">Select</form:option>
		<c:forEach items="${visitorTypeList}" var="visitorTypeListVar">
			<form:option value="${visitorTypeListVar.visitorTypeVariable}" label="${visitorTypeListVar.visitorTypeVariable}">${visitorTypeListVar.visitorTypeVariable}</form:option>
	</c:forEach>
	</form:select>
...
<li id="foli110" class="notranslate      "><label class="desc" id="title110" for="Field110">Email Id</label>
<div>
