...
<form:form commandName="designation" class="wufoo leftLabel page" action="addDesignation.htm?view=main&addOrUpdateFlag=${addOrUpdateFlag}" method="POST" >
...
<INPUT class="btTxt submit" value=Save type="submit" >
	...
	<%-- <TABLE cellSpacing=7 border="0" cellPadding=4 class="maincontent" >
        <TBODY>
        <TR>
        ...
        <TR>
          ...
          <input type="button" class=button value="Add New"  onclick="addDepartment(0);"> </TD>
          <td>
          <div id="deptdiv"></div>
          </td>
        ...
        <TR>
          <TD >Level</TD>
          <TD  align="left"><form:select  id="value_level" name="value_level" path="level" style="width: 150px;">
          <form:option value="0">--Select--</form:option>
          <c:forEach items="${designationLevels}" var="level">
          <form:option value="${level.id}">${level.levelName}</form:option>
          </c:forEach>
          </form:select> </TD>
          <TD></TD>
          <TD></TD>
        ...
        <TR>
          <TD>Rank</TD>
          <TD align="left"><form:input name="value_rank"  path="rank"></form:input> </TD>
          <TD></TD>
          <TD></TD>
          </TR>
          <tr> 
      ...
      <SPAN class=buttonborder><INPUT class=button value=Reset type=reset onclick="designation.htm"></SPAN> 
