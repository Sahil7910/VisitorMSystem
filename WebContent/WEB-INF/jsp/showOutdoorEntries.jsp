...
<form action="saveOutdoorEntries.htm" class="wufoo leftLabel page" method="POST">
...
<div>
<select class="field select medium" id="department" name="department" onchange="genericAjaxFunction('displaydepartmentwiseemployees.htm?departmentId='+this.value,'POST','employeeListDiv')">
