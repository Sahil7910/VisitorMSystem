...
<form:form name="EmployeeWiseReport" class="wufoo leftLabel page" id="EmployeeWiseReport" target="_blank" action="generateDepartmentSummaryReport.htm" method="GET">
...
<div>
<select class="field select medium" name="department" id="department">
...
<li class="buttons ">
<div>
<input class="btTxt submit" type="submit" value="Generate" />
</div>
</li>
</ul>
