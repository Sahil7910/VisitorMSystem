...
<div class="CSSTableGenerator">
	<table >
		...
		<tr>
			...
			<td><img src="images/approveIcon.png" onclick="return updateVisitorLog('updateApprovalStatusvisitorlogs.htm',${visitorLogsList.logId},'approved');"/>
			<img src="images/RejectIcon.png" onclick="return updateVisitorLog('updateApprovalStatusvisitorlogs.htm',${visitorLogsList.logId},'rejected');"/>
			</td>
		</tr>
		</c:forEach>
	</table>
