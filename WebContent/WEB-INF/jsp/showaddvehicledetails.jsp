...
<form:form encType="multipart/form-data" class="wufoo leftLabel page" action="addvehicledetails.htm" method="GET" commandName="vehicleDetails">
<ul>
...
<li id="foli110" class="notranslate"><label class="desc" id="title110" for="Field110">Vehicle Edition</label>
<div>
