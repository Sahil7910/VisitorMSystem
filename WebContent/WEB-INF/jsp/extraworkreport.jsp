...
<img  src="images/pdf.png" height="35" width="35" onclick="return generateReport('generatedepartmentwiseextraworkreport.htm?departmentId='+document.getElementById('department').value+'&');">
...
<img  src="images/word.jpg" height="35" width="35" onclick="return generateReport('generatedepartmentwiseextraworkreportInDocx.htm?departmentId='+document.getElementById('department').value+'&');">
</div>
</li>
</ul>
