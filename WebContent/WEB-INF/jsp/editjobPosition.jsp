...
<body>
<form:form commandName="jobPositions" action="updatejobposition.htm?Id=${id}" method="POST" >
<div id=maincontent>
...
<tr>
    ...
    <td width="25%" align="left"><form:input path="job_code" /></td>
...
<tr>
    ...
    <td> </td>
      ...
      <SPAN class=buttonborder><INPUT class=button value=Reset type=reset onclick="viewJobPosition.htm"></SPAN> 
