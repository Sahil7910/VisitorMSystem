...
<form:form action="addholiday.htm" method="POST" commandName="holidays" class="wufoo leftLabel page">
<ul>
<li id="foli110" 
class="notranslate">
...
<div>
<form:input path="holidayName" id="holidayName" name="holidayName" class="field text medium" />
</div>
...
<form:input type="text" id="holidayDate" name="holidayDate" path="holidayDate"
	...
	onClick="setYears(1955, 2055);showCalender(this, 'holidayDate',-350,-270);"></img>
</div>
</li>
<!-- <tr>
