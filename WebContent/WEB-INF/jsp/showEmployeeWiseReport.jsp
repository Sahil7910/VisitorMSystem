...
<!--  <input class="btTxt submit" type="button" value="Generate" onclick="return generateReport('generateEmployeeWiseReport.htm?');"/>
<input class="btTxt submit" type="button" value="Generate To Excel" onclick="return generateReport('generateEmployeeWiseReportInXSL.htm?');"/>
<input class="btTxt submit" type="button" value="Generate To Word" onclick="return generateReport('generateEmployeeWiseReportInDocx.htm?');"/>-->
<img  src="images/pdf.png" height="35" width="35" onclick="return generateReport('generateEmployeeWiseReport.htm?');">
<img  src="images/logo-excel.png" height="35" width="35" onclick="return generateReport('generateEmployeeWiseReportInXSL.htm?');">
<img  src="images/word.jpg" height="35" width="35" onclick="return generateReport('generateEmployeeWiseReportInDocx.htm?');">
</div>
</li>
</ul>
