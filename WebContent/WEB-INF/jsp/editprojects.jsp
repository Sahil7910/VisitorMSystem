...
<form:form class="wufoo leftLabel page" encType="multipart/form-data" method="POST" action="saveOrUpdateEmployeeProject.htm" commandName="projects">
<form:hidden path="id"/>
<ul>
<li id="foli110" 
class="notranslate      ">
...
<div>
<form:input type="text" id="datefrom" name="datefrom" path="fromDate" readonly="true" class="field text medium"/>
	<img
...
<div>
<form:input type="text" id="dateTo" name="dateTo" path="toDate" readonly="true" class="field text medium"/>
	<img
...
<tr>
    <td align="left" width="150px" ><font color="red" size="4" style="font-weight: bolder;">*</font> Employee Id</td>
    <td align="left" width="150px" >
    <form:select path="employeeId" id="employeeId" name="employeeId">
    <form:option value="0">Select</form:option>
    <c:forEach items="${employeeList}" var="employeeListVar">
    <form:option value="${employeeListVar.employeeId}" label="${employeeListVar.firstName} ${employeeListVar.lastName} ${employeeListVar.employeeNo}">${employeeListVar.firstName} ${employeeListVar.lastName} ${employeeListVar.employeeNo}</form:option>
    </c:forEach>
    </form:select>
    </td>
    <td></form:hidden></td>
...
<tr>
    <td align="left" width="150px"  ><font color="red" size="4" style="font-weight: bolder;">*</font> Project Name</td>
    <td align="left" width="150px" >
    <form:input path="projectName" id="projectName" name="projectName"/>
    </td>
</tr>

<tr>
    <td align="left" width="150px"  ><font color="red" size="4" style="font-weight: bolder;">*</font> From Date</td>
	<td align="left" width="150px" style="padding-left:0px;" align="left"><form:input type="text" id="datefrom" name="datefrom" path="fromDate"
	readonly="true" size="15"/> </td>
	<td align="left" width="150px"><div id="DateFromDiv">
	<img
	id="dobImageDateFrom" src="images/cal.gif" alt="cal"
...
<tr>
    <td align="left" width="150px"  ><font color="red" size="4" style="font-weight: bolder;">*</font> To Date</td>
  <td align="left" width="150px" style="padding-left:0px;" align="left"><form:input type="text" id="dateTo" name="dateTo" path="toDate"
	 readonly="true" size="15"/> </td>
	<td align="left" width="150px"><div id="DateToDiv">
	<img
	id="dobImageDateTo" src="images/cal.gif" alt="cal"
...
<tr>
    <td align="left" width="150px"  ><font color="red" size="4" style="font-weight: bolder;">*</font> Link</td>
    <td align="left" width="150px" >
    <form:input path="link" id="link" name="link"/>
    </td>
</tr>


<tr>
    <td align="left" width="150px"  ><font color="red" size="4" style="font-weight: bolder;">*</font> Client</td>
    <td align="left" width="150px" >
    <form:input path="client" id="client" name="client"/>
    </td>
</tr>

<tr>
    <td align="left" width="150px"  >Team Size</td>
  <td align="left" width="150px" >
    <form:input  path="teamSize" id="teamSize" name="teamSize"/>
    </td>
</tr>

<tr>
    <td align="left" width="150px"  ><font color="red" size="4" style="font-weight: bolder;">*</font> Role</td>
    <td align="left" width="150px" >
...
<tr>
    <td align="left" width="150px"  ><font color="red" size="4" style="font-weight: bolder;">*</font> Technology</td>
     <td align="left" width="150px" >
    <form:textarea path="technology" id="technology" name="technology"/>
    </td>
</tr>
...
<tr>
    <td align="left" width="150px"  >Project Details</td>
     <td align="left" width="150px" >
    <form:textarea path="projectDetails" id="projectDetails" name="projectDetails"/>
    </td>
</tr>

<tr>
    <td align="left" width="150px">Created By</td>
    <td align="left" width="150px" >
${projects.createdBy}
<!--     createdBy -->
    </td>
...
<tr>
    <td align="left" width="150px">Created On</td>
    <td align="left" width="150px">
   ${projects.createdOn}
   <!--  createdOn -->
    ...
    <tr>
    <td align="left" width="150px"><font color="red" size="4" style="font-weight: bolder;">*</font> - Required field</td>
    <td align="left" width="150px">
