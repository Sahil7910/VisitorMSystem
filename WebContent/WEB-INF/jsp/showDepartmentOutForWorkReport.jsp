...
<li class="buttons ">
<div>
<!-- <input class="btTxt submit" type="button" value="Generate To Pdf" onclick="return generateReport('generatedepartmentwiseOutForWorkreport.htm?departmentId='+document.getElementById('department').value+'&');"/>
<input class="btTxt submit" type="button" value="Generate To Excel" onclick="return generateReport('generatedepartmentwiseOutForWorkreportInXSL.htm?departmentId='+document.getElementById('department').value+'&');"/>
<input class="btTxt submit" type="button" value="Generate To Word" onclick="return generateReport('generatedepartmentwiseOutForWorkreportInDocx.htm?departmentId='+document.getElementById('department').value+'&');"/>
 -->
<img  src="images/pdf.png" height="35" width="35" onclick="return generateReport('generatedepartmentwiseOutForWorkreport.htm?');">
<img  src="images/logo-excel.png" height="35" width="35" onclick="return generateReport('generatedepartmentwiseOutForWorkreportInXSL.htm?');">
<img  src="images/word.jpg" height="35" width="35" onclick="return generateReport('generatedepartmentwiseOutForWorkreportInDocx.htm?');">
</div>
</li>
</ul>
...
<img  src="images/pdf.png" height="35" width="35" onclick="return generateReport('generatedepartmentwiseOutForWorkreport.htm?departmentId='+document.getElementById('department').value+'&');">
<img  src="images/logo-excel.png" height="35" width="35" onclick="return generateReport('generatedepartmentwiseOutForWorkreportInXSL.htm?departmentId='+document.getElementById('department').value+'&');">
<img  src="images/word.jpg" height="35" width="35" onclick="return generateReport('generatedepartmentwiseOutForWorkreportInDocx.htm?departmentId='+document.getElementById('department').value+'&');">
</div>
</li>
</ul>
<TABLE id="calenderTable">
