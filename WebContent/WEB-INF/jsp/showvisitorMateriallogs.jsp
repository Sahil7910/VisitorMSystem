...
<title>Visitor Material Logs Report</title>
</head>
<%
...
<li class="buttons ">
<div>
    <input class="btTxt submit" type="button" name="save" id="save" value="Generate" onclick="return generateVisitorReport('generatevisitorMaterialreport.htm');"/>
</div>
</li>
