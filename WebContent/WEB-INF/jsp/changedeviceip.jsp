...
<c:url var="onloadFunctionName" value="window.opener.document.getElementById('ipAddress').value='${ipAddress}';alert('Ip Changed');window.close();"></c:url>
</c:when>
<c:otherwise>
...
<div id="maincontent">
<form:form method="POST" name="changeIp" action="deviceChangeIp.htm">
<table cellpadding=0 cellspacing=7 border=0 id="fields_block">
<tr>
    <td  align="left" width=150 style="padding-left:0px;">Enter New IP</td>
    <td align="left" width=250 ><input type="text" id="ipAddress" name="ipAddress"/><input type="hidden" id="oldIp" name="oldIp" value="${oldIp}"/></td>
    
</tr>
<tr><td><input type="submit" name="save" id="save" value="Save IP"/></td><td></td></tr>
 </table>
</form:form>
</div>
</body>
