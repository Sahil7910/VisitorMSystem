...
<form:form class="wufoo leftLabel page" method="POST" action="" name="employeeForm" onsubmit="getSelectedEmployeeDetails('showEducationDetails.htm','employeeId');">
<ul>
<li id="foli23" class="notranslate      "><label class="desc" id="title23" for="Field23"></label>
