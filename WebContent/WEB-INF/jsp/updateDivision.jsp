...
<form:form action="updateDivision.htm" class="wufoo leftLabel page" method="POST" commandName="division">

<form:hidden path="divisionId" id="divisionId" name="divisionId"/>
<ul>
...
<c:forEach items="${employeeList}" var="employee">
	<c:choose>
		<c:when test="${division.divisionId==employee.employeeId}">
...
<div>
<form:select path="locationId" id="location_Id" name="location_Id">
