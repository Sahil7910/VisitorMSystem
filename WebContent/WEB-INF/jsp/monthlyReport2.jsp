...
<form:form name="EmployeeWiseReport" class="wufoo leftLabel page" id="EmployeeWiseReport" method="POST" action="generateMonthlyReport2.htm" target="_blank">
...
<div>
<select id="allowedTime" class="field select medium" name="allowedTime">
